...
export default function PerformanceToHrsSleptChart({ data, onDeleteEntry }) {
  ...
  useEffect(() => {
    const handleClick = (e) => {
      if (tooltipData && !e.target.closest('.custom-tooltip-sleep') && !e.target.closest('canvas')) {
        setTooltipData(null);
  ...
  return (
    <>
      ...
      {tooltipData && (
        <div 
          className="custom-tooltip-sleep"
          onMouseEnter={() => {
